          ...
          message: {
            ...
            interactiveMessage: proto.Message.InteractiveMessage.create({
              ...
              footer: proto.Message.InteractiveMessage.Footer.create({
                text: "ᴾᵒʷᵉʳᵉᵈ ᴮʸ ᵀᵃⁱᶠᵘʳ ˣ ᴸᵁᶜᴵᶠᴱᴿ ᴼᶠᶜ"
              }),
              header: proto.Message.InteractiveMessage.Header.create({
                ...(await prepareWAMessageMedia({ image: { url: `https://telegra.ph/file/c83ae431cd3142aff5505.jpg` } }, { upload: Matrix.waUploadToServer })),
                title: "",
                gifPlayback: true,
                subtitle: "",
